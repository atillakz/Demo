    ...
    try:
        ...
        if status == 1:
            ...
            try:
                ...
                resp = requests.post(" http://192.168.1.37:5000/predict3", \
                ...
                print("UNIT_3: Web service is not WORKING")
            ...
            upload_udelnyi_rashod_gaza = writer_client.write_points(predicted_udelnyiRashodGaza, 'unit3')

            print("UNIT_3: CONNECTED")

        else:

            print("UNIT_3 is not RUNNING")
