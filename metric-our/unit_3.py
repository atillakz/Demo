...
query_for_agp = (
    "SELECT id,unit_notready, unit_stdby,unit_run,unit_loaded, emerg_stop_blow_cnt,emrg_stop_cnt, gas_fuel_flow,hpc_flow_act,ufoh, unit_attempts, start_count, dateandtime FROM zsse.Unit3_Labview ORDER BY id DESC LIMIT 1")
...
while True:
    ...
    if id_to_check['check'] != id:
        ...
        try:
            ...
            print("UNIT_3 : There is No DATABASE to INSERT ")
